...
--
-- Host: db
-- Generation Time: Apr 20, 2026 at 06:46 PM
...
(1, 'Pan Salado', 'Panes de corteza dura y miga aireada, ideales para acompañar comidas.'),
(2, 'Repostería Fina', 'Pasteles, tartas y postres elaborados para eventos especiales.'),
(3, 'Galletería', 'Variedad de galletas horneadas diariamente.'),
(4, 'Pan Dulce Tradicional', 'Conchas, orejas y piezas clásicas de la panadería local.');
...
(1, 'Molinos del Centro', 'Ricardo Haro', '555-0102'),
(2, 'Lácteos Frescos S.A.', 'Beatriz Luna', '555-0304'),
(3, 'Distribuidora de Azúcares', 'Carlos Peña', '555-0506'),
(4, 'Chocolate Gourmet Mx', 'Sofía Reyes', '555-0708');
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`address_id`) REFERENCES `user_addresses` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
--
ALTER TABLE `products`
  ADD CONSTRAINT `products_ibfk_1` FOREIGN KEY (`supplier_id`) REFERENCES `suppliers` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
